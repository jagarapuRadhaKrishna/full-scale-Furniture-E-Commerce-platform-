...
const products = categoryProducts.Outdoor?.filter((p: any) => p.subCategory === 'Chairs') || []

export default function GardenChairsPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="mb-4">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>/</li>
              <li><Link href="/categories/outdoor" className="hover:text-orange-200">Outdoor</Link></li>
              <li>/</li>
              <li className="text-orange-200">Garden Chairs</li>
            </ol>
          </nav>
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            Discover our premium collection of {products.length}+ garden chairs
          </p>
        </div>
      </div>
