...
const products = categoryProducts.Office?.filter((p: any) => p.subCategory === 'Storage') || []

export default function FilingCabinetsPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="mb-4">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>/</li>
              <li><Link href="/categories/office" className="hover:text-orange-200">Office</Link></li>
              <li>/</li>
              <li className="text-orange-200">Filing Cabinets</li>
            </ol>
          </nav>
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            Discover our premium collection of {products.length}+ filing cabinets
          </p>
        </div>
      </div>
