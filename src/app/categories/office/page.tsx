...
const officeProducts = categoryProducts.Office
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFE8DB] via-[#FFF5F0] to-[#FFD9C8]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-furniture-light-brown max-w-2xl mx-auto">
              Build your productive workspace with our professional furniture collection.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">All Office Products</h2>
            <p className="text-gray-600">{officeProducts.length} items available</p>
          </div>
          <Link 
            href="/book-demo?category=office"
