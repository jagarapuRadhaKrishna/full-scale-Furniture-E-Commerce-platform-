...
const livingRoomProducts = categoryProducts['Living Room']
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFE8DB] via-[#FFF5F0] to-[#FFD9C8]">
      <ModuleHeader 
        ...
        backUrl="/"
      />
      <div className="bg-furniture-brown text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-furniture-light-brown max-w-2xl mx-auto">
              Create the perfect living space with our premium furniture collection.
              Every piece features 360 viewing and FREE home demo.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">All Living Room Products</h2>
            <p className="text-gray-600">{livingRoomProducts.length} items available</p>
          </div>
          <Link 
            href="/book-demo?category=living-room"
              ...
              <div className="mt-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button className="bg-furniture-brown text-white px-6 py-2 rounded-lg font-semibold hover:bg-furniture-dark-wood transition duration-200">
                      Add to Cart
                    </button>
                  </div>
                </div>
