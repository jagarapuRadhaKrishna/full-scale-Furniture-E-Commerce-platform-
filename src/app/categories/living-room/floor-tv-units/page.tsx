...
export default function FloorTVUnitsPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="mb-4">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>/</li>
              <li className="text-orange-200">Floor TV Units</li>
            </ol>
          </nav>
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            Discover our premium collection of {products.length}+ floor tv units
          </p>
        </div>
      </div>
