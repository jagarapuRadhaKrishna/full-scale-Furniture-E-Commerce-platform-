...
export default function GlassDiningTablesPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="mb-4">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>/</li>
              <li className="text-orange-200">Glass Dining Tables</li>
            </ol>
          </nav>
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            Discover our premium collection of {products.length}+ glass dining tables
          </p>
        </div>
      </div>
